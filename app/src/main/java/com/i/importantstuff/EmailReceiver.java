...
//                Toast.makeText(context, ""+messageContent, Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(context, ""+"No provider for protocol: " + protocol, Toast.LENGTH_SHORT).show();

            ex.printStackTrace();
        } catch (final MessagingException ex) {
            System.out.println("Could not connect to the message store");
//            Toast.makeText(context, "Could not connect to the message store"+ex, Toast.LENGTH_SHORT).show();

            Log.d("errormsg",ex.toString());
...
//
//
//        String userName = "kevmirera@gmail.com";
//        String password = "awesome96!";
//
